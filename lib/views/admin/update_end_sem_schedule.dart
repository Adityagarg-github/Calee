...
class updateEndSemSchedule extends StatefulWidget {
  const updateEndSemSchedule({super.key});

  @override
  State<updateEndSemSchedule> createState() => _updateCoursesState();
}

class _updateCoursesState extends State<updateEndSemSchedule> {
  String? filePath;
  ...
  void _pickFile(ScaffoldMessengerState sm) async {
    ...
    try {
      String fileName = 'EndSemTable.csv';
    ...
    return Scaffold(
        ...
        body: Column(children: [
          ...
          Padding(
            ...
            child: Image.asset('assets/endSemSample.png'),
          ),
          const SizedBox(height: 5),
          const Text(
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              ...
              File nfile = File(p.join(result, 'EndSemTableSample.csv'));
              nfile.writeAsString(
                  await rootBundle.loadString('assets/EndSemTable.csv'));
            },
          ),
        ]));
  }
